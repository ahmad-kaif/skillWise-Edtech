  ...
  const features = [
    {
      ...
      title: "Live Classes",
      description:
        "Dive into interactive courses with cutting-edge visualization technology",
    ...
    },
    {
      ...
      title: "AI Mentorship",
      description:
        "Personalized guidance powered by chatbot",
    ...
    },
    {
      ...
      description: "User comments will be marked postive/negative",
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      <div className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div
          className={`absolute inset-0 bg-gradient-radial from-blue-500/20 to-transparent transition-opacity duration-1000 ${
        ...
        <div className="relative z-10 text-center max-w-4xl px-6 transition-all duration-1000 transform translate-y-0">
          ...
          <p
            className={`text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto transition-all delay-300 duration-1000 ${
              isLoaded ? "opacity-100" : "opacity-0"
            }`}
          >
            A revolutionary platform where innovation meets education, designed
          ...
          >
            <Link to="/register"  className="px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg shadow-blue-500/30 text-white font-medium tracking-wide">
              Explore Interface
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {features.map((feature) => (
                <div
                  key={feature.id}
                  className={`p-6 rounded-xl transition-all duration-500 backdrop-blur-sm border border-white/10 ${
              ...
              {features.map((feature) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      className={`h-32 w-32 rounded-full bg-gradient-to-br ${feature.color} animate-pulse-slow opacity-60 blur-2xl`}
                    ></div>
                    <div
                      className={`absolute h-16 w-16 rounded-full bg-gradient-to-br ${feature.color} flex items-center justify-center`}
                    >
